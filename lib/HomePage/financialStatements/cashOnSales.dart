...
class CashOnSales extends StatefulWidget {
  @override
  _CashOnSalesState createState() => _CashOnSalesState();
}

class _CashOnSalesState extends State<CashOnSales> {
  ...
  Widget build(BuildContext context) {
    ...
    double total = 0;
    demoDataCashOnSale.forEach((element) {total+=element.receivedAmount;});

    return Scaffold(
      appBar: MyAppBar(title: 'Cash On Sales',),
