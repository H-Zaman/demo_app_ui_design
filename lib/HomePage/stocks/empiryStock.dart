...
class ExpiryStocks extends StatefulWidget {
  @override
  _ExpiryStocksState createState() => _ExpiryStocksState();
}

class _ExpiryStocksState extends State<ExpiryStocks> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          appBar: MyAppBar(title: 'Expiry Stocks',),
