...
class SaleWise extends StatefulWidget {
  @override
  _SaleWiseState createState() => _SaleWiseState();
}

class _SaleWiseState extends State<SaleWise> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          appBar: MyAppBar(title: 'Sale Wise',),
